            ...
            <div class="search {{ $dark ? 'search-no-borders border-0' : '' }}">
                ...
                <div class="search__content">
                    ...
                    <div class="search__content-item">
                            ...
                            <div class="input-field {{ $dark ? 'input-field--transparent' : '' }}">
                                <input type="text" id="leaflet_search" placeholder="{{ __('enter_a_location') }}" name="location" value="{{ $oldLocation }}" autocomplete="off"/>
                                <span class="icon icon--left">
                                    <x-svg.search-location-icon />
                                </span>
                            </div>
                    ...
                    <div class="search__content-item">
                        <div class="input-field {{ $dark ? 'input-field--transparent' : '' }}">
                            <select name="category" id="category_select" style="width: calc(100% - 60px);">
                                @php
