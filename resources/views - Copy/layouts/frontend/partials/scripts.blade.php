...
<script src="{{ mix('frontend/js/chat.js') }}"></script> <!-- for pusher js in realtime chat -->
<script src="{{ mix('frontend/js/vendor.min.js') }}"></script>
<script>
    ...
    $('#currency_switch_button').on('click', function() {
        $('#currency_switch_dropdown').toggle();
    });
</script>
