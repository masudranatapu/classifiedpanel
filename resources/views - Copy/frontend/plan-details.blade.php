...
@section('content')
    ...
    <section class="section benefits bgcolor--gray-10">
        <div class="container">
            ...
            <div class="row">
                <h2 class="mb-2 text--heading-1">{{ __('online_payment') }}</h2>
                {{-- Paypal payment --}}
            ...
            <div class="row">
                <h2 class="mb-2 text--heading-1">{{ __('offline_payment') }}</h2>
                ...
                <div class="col-xl-6">
                    <form action="{{ route('manual.payment') }}" method="post">
                        ...
                        <div class="membership-card">
                            ...
                            <div class="membership-card__info">
                                <h2 class="membership-card__title text--body-1">{{ $payment->name }}</h2>
