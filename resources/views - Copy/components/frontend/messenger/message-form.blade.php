<form action="{{ route('frontend.message.store',$user->username) }}" method="POST" id="messageForm">
    ...
    <div class="input-message--text">
        <textarea placeholder="{{ __('type_your_message') }}..." name="body" style="padding-bottom: 10px;" id="messageBodyyy"></textarea>
...
<script>
    ...
    const messageBody = document.getElementById('messageBodyyy');
